...
public class BotService {
    ...
    @Autowired
    public BotService(BotClient botClient,
    ...
    private void setupMessageHandlers() {
        botClient.onMessage(filter -> filter.commands("start"), messageService::handleStartCommand);
        botClient.onMessage(filter -> filter.commands("newactivity"), messageService::handleNewActivityCommand);
